"""Shared hydrogen technology resolution and financial-result model."""
    ...
    *,
    ...
    result: dict[str, np.ndarray] = {
        ...
        **dict(prices),
        ...
        "lcoh_eur_per_th2": financial_result["levelized_cost"],
        "levelized_profit_margin_eur_per_th2": financial_result[
